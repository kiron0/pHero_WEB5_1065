...
1. Find the documentation of console tab utilities API. And then read it. Spend 3
0-45 minutes.
...
----------------
Task-1:
9. Simple website. You will have a input and a output button. Input field will take an email. Use regular expression to validate that user is inserting an email. (Find the regEx by searching online)
